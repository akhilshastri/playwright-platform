...
// Run the tests linked to changed flows
function runTests(testsToRun) {
  if (testsToRun.length === 0) {
    console.log('No tests to run for the changed flows.');
    return;
  }

  console.log(`Found ${testsToRun.length} tests linked to changed flows.`);
